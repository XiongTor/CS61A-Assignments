...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    det_lat = get_lat(city_a) - get_lat(city_b)
    det_long = get_lon(city_a) - get_lon(city_b)
    return sqrt(det_lat*det_lat + det_long*det_long)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    a_distance = distance(ref,city_a)
    b_distance = distance(ref,city_b)
